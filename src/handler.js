...
const getBookHandler = (request, h) => {
  ...
  if (queryData?.name) {
    data = data.filter((book) => book.name.toLowerCase().includes(queryData.name.toLowerCase()));
  }

  if (queryData?.reading) {
    data = data.filter((book) => book.reading === !!Number(queryData.reading));
  }
